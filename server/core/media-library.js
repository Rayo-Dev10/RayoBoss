...
function seed() {
  return {
    ...
    revision: 1,
    items: [
      { id: 'demo-indie', title: 'Pieza independiente de demostración', category: 'autodj.libre', kind: 'audio', contentType: 'audio/mpeg', url: '/media/indie-demo.mp3', durationSeconds: 18, active: true, bundled: true, rights: { basis: 'Generación sintética propia para prueba', reference: 'RayoBoss 4.0.1' }, createdAt: nowIso() },
      { id: 'demo-graduacion', title: 'Ceremonia de graduación — video de prueba', category: 'autodj.libre', kind: 'video', contentType: 'video/mp4', url: '/media/graduacion-demo.mp4', durationSeconds: 12, active: true, bundled: true, rights: { basis: 'Video y audio sintéticos propios', reference: 'RayoBoss 4.0.1' }, createdAt: nowIso() },
